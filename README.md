...
El proyecto cuenta con 3 clases en el lenguaje python:
	main, la clase con la l¨®gica
	pila, encargada de gestionar la pila
	cola, encargada de gestionar la cola
	
Adem¨¢s tiene 2 archivos .txt:
	libros.txt, que contiene los libros con los datos de Titulo, Autor, Tem¨¢tica, P¨¢ginas y Editorial.
	busquedas.txt, un archivo plano vac¨ªo en donde se guardara el resultado de los filtros.
...
El resultado del fltro se puede ver en el archivo busquedas.txt, los filtros se dan por cada una de las categor¨ªas del libro (Titulo, Autor, Tem¨¢tica, P¨¢ginas y Editorial).
